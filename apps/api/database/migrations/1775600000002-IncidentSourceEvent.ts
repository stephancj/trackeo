...
export class IncidentSourceEvent1775600000002 implements MigrationInterface {
  name = 'IncidentSourceEvent1775600000002';
  ...
  async down(queryRunner: QueryRunner) {
    await queryRunner.query(
      'ALTER TABLE security_incidents DROP COLUMN IF EXISTS source_event_id',
    );
  }
}
